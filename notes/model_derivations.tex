...
Despite this ambiguity in bilateral exchange-rate adjustments, aggregation shows that $A$'s NEER appreciates for every $\rho$ and $N$, i.e., the conventional wisdom survives in effective exchange rates. Therefore, a core takeaway from our analysis is the organizing distinction between aggregate \emph{home-versus-foreign adjustment} and \emph{reallocation across foreign suppliers}. Under symmetry, the aggregate margin determines the sign of the effective exchange-rate response, while reallocation determines its bilateral distribution. 
