...
Under \eqref{eq:invpos}, the direct CPI effect makes real bilateral reversal harder than nominal reversal, $\rho_q^*(N) > N\rho_1^*$, and reinforces effective appreciation: the REER response is negative for all $\rho$ and $N$, and strictly larger in magnitude than the pass-through of the nominal response alone.
\label{res:real}
\end{proposition}
