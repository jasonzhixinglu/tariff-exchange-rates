...
\noindent Therefore, the Viner--Mundell result is a direct corollary of our nested-CES model. The canonical restrictions push the threshold down to $\rho_3^* \leq 0$, so the reversal condition $\rho > \rho_3^*$ is satisfied by every $\rho > 0$. 
